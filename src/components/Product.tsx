...
export default function Product({
  ...
  return (
    <div
      className="w-full max-w-[350px] sm:max-w-[380px] md:max-w-[420px] lg:max-w-[450px] xl:max-w-[480px] h-auto min-h-[420px] sm:min-h-[400px] md:min-h-[450px] lg:min-h-[500px] xl:min-h-[550px] flex flex-col items-center justify-center flex-1 min-w-[320px] sm:min-w-[320px] relative"
      style={{
    ...
    >
      <div className="w-full flex justify-center mb-4 sm:mb-5 md:mb-6 lg:mb-7 xl:mb-8 relative">
        ...
        <div
          className="w-full h-auto aspect-square rounded-xl sm:rounded-2xl md:rounded-3xl bg-gray-200 animate-pulse"
          style={{
        ...
        <Image
          ...
          width={420}
          height={420}
          className="w-full h-auto aspect-square rounded-xl sm:rounded-2xl md:rounded-3xl object-cover"
          style={{
            transform: 'rotate(0deg)',
